package com.pj.portfolio.controller;

import com.pj.portfolio.entity.*;
import com.pj.portfolio.service.interfaces.*;
...
public class BaseController {
    ...
    private void getSkillAttributes(Model theModel){
        ...
        List<Skill> general = skillService.getSkillsByCategory("General");
